...
function OperationDataBox({ operation }) {
  const {
    created_at,
    report,
    date,
    ...
    <section>
      <Header>
        ...
        <p>
          ...
          ) &mdash; {format(new Date(startDate), "EEE, MMM dd yyyy")}
        </p>
      </Header>
      ...
      <Footer>
        <p>operated {format(new Date(created_at), "EEE, MMM dd yyyy, p")}</p>
      </Footer>
    </section>
  );
}

export default OperationDataBox;
